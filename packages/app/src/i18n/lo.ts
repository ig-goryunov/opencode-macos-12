export const dict = {
  ...
  "session.browser.placeholder": "Enter a URL",
  "session.browser.reload": "Reload",
  "session.browser.openExternal": "Open in external browser",
  "session.browser.desktopOnly": "The embedded browser is available in the desktop app. Open the URL in your external browser instead.",
  "session.browser.error": "This page could not be loaded.",
  "session.browser.retry": "Retry",
  "session.browser.empty": "Enter a local or remote URL to preview it here.",
  "session.browser.rewroteLocalhost": "Using the server host for localhost",
