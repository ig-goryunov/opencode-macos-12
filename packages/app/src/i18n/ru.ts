export const dict = {
  ...
  "session.browser.placeholder": "Введите URL",
  "session.browser.reload": "Обновить",
  "session.browser.openExternal": "Открыть во внешнем браузере",
  "session.browser.desktopOnly": "Встроенный браузер доступен в десктопном приложении. Откройте URL во внешнем браузере.",
  "session.browser.error": "Не удалось загрузить страницу.",
  "session.browser.retry": "Повторить",
  "session.browser.empty": "Введите локальный или удалённый URL, чтобы открыть его здесь.",
  "session.browser.rewroteLocalhost": "localhost заменён на хост сервера",
